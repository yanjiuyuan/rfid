    ...
    methods: {
        ...
        getBomInfo() {
            ...
            switch (FlowId) {
                ...
                case '24': url = "Pick/Read"; break;//11111111111111
                case '26': url = "Pick/Read"; break;
                case '27': url = "Godown/Read"; break;
            }
            if (!url) return
            this.GetData(url + _formatQueryStr({ TaskId: DingData.userid }), (res) => {
                this.data = res
            })
        },
        //打印表单
        printPdf() {
            ...
            switch (FlowId) {
                ...
                case '8': url = "PurchaseNew/ReadPurchaseTable"; break;
                case '12': url = "ItemCodeAdd/GetTable"; break;
                case '24': url = "Pick/Read"; break;//22222222
                case '26': url = "Pick/Read"; break;
                case '27': url = "Godown/Read"; break;
            }
            if (!url) return
